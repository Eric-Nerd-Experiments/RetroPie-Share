...
rp_module_database_excluded_versions=( 242 244 254 256 257 268 269 270 273 288)
...
- add database\n\
285.01 :\n\
- add taito to database\n\
- fix audio samples download and still using 278\n\
285.00 :\n\
- add database\n\
284.00 :\n\
- add database\n\
